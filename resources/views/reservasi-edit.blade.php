...
<div class="container mx-auto p-4">
    <div class="bg-[#d3e2f1] rounded-lg shadow-lg p-6 mb-6">
        <div class="flex justify-start items-center mb-4">
            ...
            <h1 class="text-3xl font-bold text-[#0A0A0A]">Ubah Reservasi Pasien</h1>
        </div>
        <form onsubmit="submitEditForm(event)" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-2">
                <button type="submit" class="bg-blue-500 hover:bg-blue-400 text-white font-semibold px-4 py-2 rounded-md shadow-md transition duration-300"><i class="fa-solid fa-calendar-check mr-2"></i>Ubah Reservasi</button>
