    ...
    <div class="bg-[#d3e2f1] rounded-lg shadow-lg p-6 mb-6">
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="flex justify-end gap-2">
                <button type="submit" class="bg-green-500 hover:bg-green-400 text-white font-semibold px-4 py-2 rounded-md shadow-md transition duration-300"><i class="fa-solid fa-floppy-disk mr-2"></i>Buat Reservasi</button>
