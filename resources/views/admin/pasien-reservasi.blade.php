        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" id="tanggal" name="tanggal" class="mt-1 block w-full px-4 py-2 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" value="{{ old('tanggal') }}">
            ...
            <div class="flex justify-end gap-2">
                <button type="submit" class="bg-green-500 hover:bg-green-400 text-white font-semibold px-4 py-2 rounded-md shadow-md transition duration-300">Buat Reservasi</button>
                <a href="{{ route('admin.data.pasien') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg py-2 px-4 w-min text-nowrap">Kembali</a>
            </div>
        </form>
    </div>
</div>
