...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-6xl mx-auto bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-300 dark:border-gray-600">
        <div class="flex items-center mb-6">
            ...
            <div class="ml-4">
                <p class="text-2xl md:text-3xl font-bold dark:text-white">Edit Perawat</p>
                <p class="text-gray-500 text-md dark:text-gray-300">Silahkan ubah formulir di bawah ini untuk mengubah data diri perawat di sistem.</p>
            </div>
        </div>
        ...
        <div class="mb-4">
            <label for="nama" class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Nama Lengkap</label>
            <input type="text" name="nama" id="nama" class="w-full p-2 border border-gray-300 dark:border-gray-700 dark-text-white dark:placeholder-gray-400 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan nama lengkap" value="{{ old('nama', $perawat->nama) }}">
            @error('nama')
                <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            <label for="nomor_handphone" class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Nomor Handphone</label>
            <input type="number" name="nomor_handphone" id="nomor_handphone" class="w-full p-2 border border-gray-300 dark:border-gray-700 dark-text-white dark:placeholder-gray-400 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan nomor handphone" value="{{ old('nomor_handphone', $perawat->nomor_handphone) }}">
            @error('nomor_handphone')
                <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            <label for="alamat" class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Alamat</label>
            <input type="text" name="alamat" id="alamat" class="w-full p-2 border border-gray-300 dark:border-gray-700 dark-text-white dark:placeholder-gray-400 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan alamat" value="{{ old('alamat', $perawat->alamat) }}">
            @error('alamat')
                <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-4">
            <p class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Jenis Kelamin</p>
        ...
        <div class="mb-4 relative">
            <label for="password" class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Kata Sandi</label>
            <input type="password" name="password" id="password" class="w-full p-2 border border-gray-300 dark:border-gray-700 dark-text-white dark:placeholder-gray-400 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan kata sandi">
        ...
        <div class="mb-4 relative">
            <label for="konfirmasi_password" class="block text-gray-700 font-semibold dark:text-gray-200 mb-2">Konfirmasi Kata Sandi</label>
            <input type="password" name="konfirmasi_password" id="konfirmasi_password" class="w-full p-2 border border-gray-300 dark:border-gray-700 dark-text-white dark:placeholder-gray-400 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan konfirmasi kata sandi">
