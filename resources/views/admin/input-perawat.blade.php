    ...
    <form action="{{ route('admin.perawat.input') }}" method="POST" enctype="multipart/form-data" class="flex justify-center">
        ...
        <div class="flex flex-col items-center gap-4 w-1/2">
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="text" name="nama" id="nama" placeholder="Masukkan nama lengkap" class="rounded-lg" value="{{ old('nama') }}" autofocus>
                @error('nama')
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="number" name="nomor_handphone" id="nomor_handphone" placeholder="Masukkan nomor handphone" class="rounded-lg" value="{{ old('nomor_handphone') }}">
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="text" name="alamat" id="alamat" placeholder="Masukkan alamat" class="rounded-lg" value="{{ old('alamat') }}">
                @error('alamat')
                    <div class="text-[#B42223] text-bold text-sm">
                        {{ $message }}
                    </div>
...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-300">
        <div class="flex items-center mb-6">
            ...
            <div class="ml-4">
                <p class="text-2xl md:text-3xl font-bold">Tambah Perawat</p>
                <p class="text-gray-500 text-md">Silahkan lengkapi formulir di bawah ini untuk menambahkan perawat baru ke sistem.</p>
            </div>
        </div>
        <form action="{{ route('admin.perawat.input') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan nama lengkap" value="{{ old('nama') }}" autofocus>
                @error('nama')
            ...
            <div class="mb-4">
                ...
                <input type="number" name="nomor_handphone" id="nomor_handphone" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan nomor handphone" value="{{ old('nomor_handphone') }}">
                @error('nomor_handphone')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="alamat" id="alamat" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan alamat" value="{{ old('alamat') }}">
                @error('alamat')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
