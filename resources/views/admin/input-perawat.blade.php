    ...
    <div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-gray-300">
        ...
        <form action="{{ route('admin.perawat.input') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" class="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500" placeholder="Masukkan nama lengkap" value="{{ old('nama') }}">
                @error('nama')
