...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-6xl mx-auto bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-300 dark:border-gray-700">
        <div class="flex items-center mb-6">
            ...
            <div class="ml-4">
                <p class="text-2xl md:text-3xl font-bold dark:text-white">Tambah Dokter</p>
                <p class="text-gray-500 dark:text-gray-300 text-sm">Silahkan lengkapi formulir di bawah ini untuk menambahkan dokter baru ke sistem.</p>
            </div>
        </div>
        <form action="{{ route('admin.dokter.input') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex flex-col items-center w-full">
                ...
                <div id="div-foto" class="w-1/3 h-1/3 md:w-40 md:h-40 aspect-square overflow-hidden rounded-full border-2 border-gray-300 dark:border-gray-600 hidden mb-4">
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="text" name="nama" id="nama" placeholder="Masukkan nama lengkap" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-300" value="{{ old('nama') }}">
                @error('nama')
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="number" name="nomor_handphone" id="nomor_handphone" placeholder="Masukkan nomor handphone" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-300" value="{{ old('nomor_handphone') }}">
            ...
            <div class="flex flex-col w-full">
                ...
                <input type="text" name="alamat" id="alamat" placeholder="Masukkan alamat" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-300" value="{{ old('alamat') }}">
                @error('alamat')
                    <div class="text-red-500 mt-1 text-sm">{{ $message }}</div>
                @enderror
            </div>
            <div class="flex flex-col w-full">
                <label for="spesialis" class="block text-gray-700 dark:text-gray-300 font-semibold mb-2">Spesialis</label>
                <select id="spesialis" name="spesialis" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:text-gray-300">
            ...
            <div class="flex flex-col w-full relative">
                ...
                <input type="password" name="password" id="password" placeholder="Masukkan kata sandi" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-300">
            ...
            <div class="flex flex-col w-full relative">
                ...
                <input type="password" name="konfirmasi_password" id="konfirmasi_password" placeholder="Masukkan konfirmasi kata sandi" class="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:text-gray-300">
                <i class="fa-solid fa-eye absolute right-3 bottom-3 cursor-pointer text-gray-500 dark:text-gray-300" id="toggle-password-2"></i>
