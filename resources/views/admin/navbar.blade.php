...
<div class="fixed left-0 top-0 w-64 h-full bg-[#E3EBF3] p-4 z-50 sidebar-menu transition-transform -translate-x-full md:translate-x-0">
    ...
    <ul class="mt-4">
        ...
        <li class="mb-1 group">
            <a href="{{ route('admin.index.dokter') }}" class="flex font-semibold items-center py-2 px-4 rounded-md text-gray-900 hover:bg-[#222C67] hover:text-gray-100 {{ request()->is('admin/dokter*') ? 'bg-[#222C67] text-white' : '' }}">
