...
<div class="container mx-auto px-4 py-6 ">
    <div class="max-w-6xl mx-auto bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-300 dark:border-gray-700">
        <div class="flex items-center mb-6">
            ...
            <div class="ml-4">
                <p class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-200">Edit Jadwal Dokter</p>
                <p class="text-gray-500 dark:text-gray-400 text-md">Silahkan ubah formulir di bawah ini untuk mengubah jadwal dokter di sistem.</p>
            </div>
        </div>
        <form onsubmit="submitEditForm(event)" method="POST" class="space-y-4">
            ...
            <div class="flex flex-col items-center w-full">
                {{-- tidak ada foto --}}
                @if(!$dokter->foto)
                    <svg id="ikon-bawaan" class="w-2/5 h-2/5 md:w-52 md:h-52" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#222c67" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                ...
                {{-- ada foto --}}
                @else
                    <div id="div-foto-lama" class="w-1/3 h-1/3 md:w-40 md:h-40 aspect-square overflow-hidden rounded-full border-2 border-gray-300 dark:border-gray-700 mb-4">
                        <img id="tampilkan-foto-lama" src="{{ asset('storage/' . $dokter->foto) }}" alt="foto-profil" class="object-cover object-top w-full h-full">
                    </div>
                @endif
                <p class="text-2xl font-semibold text-gray-900 dark:text-gray-200">{{ $dokter->nama }}</p>
            </div>
            <div class="flex flex-col w-full">
                <label for="senin" class="text-gray-700 dark:text-gray-300">Senin</label>
                <select id="senin" name="senin" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
            ...
            <div class="flex flex-col w-full">
                ...
                <select id="selasa" name="selasa" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
            ...
            <div class="flex flex-col w-full">
                ...
                <select id="rabu" name="rabu" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
            ...
            <div class="flex flex-col w-full">
                ...
                <select id="kamis" name="kamis" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
            ...
            <div class="flex flex-col w-full">
                ...
                <select id="jumat" name="jumat" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
            ...
            <div class="flex flex-col w-full">
                ...
                <select id="sabtu" name="sabtu" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
            ...
            <div class="flex flex-col w-full">
                <label for="minggu" class="text-gray-700 dark:text-gray-300">Minggu</label>
                <select id="minggu" name="minggu" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                    <option value="">Pilih jam</option>
                    @php
