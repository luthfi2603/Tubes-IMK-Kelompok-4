        ...
        <table class="min-w-full bg-white dark:bg-gray-900">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-3 border-b-2 border-gray-200 dark:border-gray-700 bg-gray-200 dark:bg-gray-700 text-left text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Pasien</th>
