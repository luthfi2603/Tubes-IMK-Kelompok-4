...
<div class="flex flex-col lg:flex-row w-full p-4 space-y-6 lg:space-y-0 lg:space-x-6">
        ...
        <div class="mt-8">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-blue-100 p-4 rounded-lg flex items-center space-x-4">
    ...
    <div class="w-full lg:w-1/3">
        <div class="bg-white rounded-lg shadow-lg border-gray-300 mb-6 w-full pb-4">
            ...
            <div class="flex justify-center pb-6 pt-3">
                <div inline-datepicker data-date="02/02/"></div>
            </div>
        </div>
        <div>
