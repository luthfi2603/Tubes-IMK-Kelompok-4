<li class="mb-1 group">
    <a href="{{ route('dokter.dashboard') }}" class="flex font-semibold items-center py-2 px-4 dark:text-gray-400 text-gray-900 hover:bg-[#222C67] dark:hover:text-gray-50 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 {{ request()->is('dokter/dashboard') ? 'bg-[#222C67] text-white dark:text-white' : '' }}">
...
<li class="mb-1 group">
    <a href="{{ route('dokter.rekam.medis') }}" class="flex font-semibold items-center py-2 px-4 dark:text-gray-400 text-gray-900 hover:bg-[#222C67] dark:hover:text-gray-50 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 {{ request()->is('dokter/rekam-medis*') ? 'bg-[#222C67] text-white dark:text-white' : '' }}">
        <i class="fa-solid fa-notes-medical mr-3 text-lg"></i>
        <span class="text-md">Daftar Rekam Medis</span>
    </a>
</li>
<li class="mb-1 group">
    <a href="{{ route('dokter.dokter.kami') }}" class="flex font-semibold items-center py-2 px-4 dark:text-gray-400 text-gray-900 hover:bg-[#222C67] dark:hover:text-gray-50 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 {{ request()->is('dokter/dokter-kami') ? 'bg-[#222C67] text-white dark:text-white' : '' }}">
