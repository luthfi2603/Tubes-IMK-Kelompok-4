...
<div class="flex flex-col gap-4">
    ...
    <div class="border-gray-300 rounded-2xl flex border-4 md:max-h-[135px]">
        <div class="w-1/4 flex">
            <img src="{{ asset('./assets/img/logo.png') }}" alt="dokter" class="m-auto md:h-full">
        </div>
        <div class="w-full p-2 md:pr-7">
            <div class="md:hidden">
            ...
            <div class="flex items-center mt-1 md:justify-end">
                <p class="text-blue-900 font-bold leading-none mr-3">Buat janji</p>
