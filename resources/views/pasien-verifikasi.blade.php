...
@if(session()->has('success'))
    <div id="success-php" class="bg-[#d1e7dd] dark:bg-green-800 text-[#0f5132] dark:text-green-100 border-2 border-[#badbcc] dark:border-green-600 px-4 py-3 rounded-lg fixed inset-x-[296px] z-[999]">
        <i class="fa-regular fa-circle-check mr-1"></i>
        <span>{{ session('success') }}</span>
    </div>
@elseif(session()->has('failed'))
    <div id="failed-php" class="bg-[#f8d7da] dark:bg-red-800 text-[#842029] dark:text-red-100 border-2 border-[#f5c2c7] dark:border-red-600 px-4 py-3 rounded-lg fixed inset-x-[296px] z-[999]">
        <i class="fa-solid fa-circle-exclamation mr-1"></i>
        <span>{{ session('failed') }}</span>
    </div>
@endif
<div id="success-2" class="bg-green-300 dark:bg-green-800 py-3 text-white px-4 rounded-lg hidden"></div>
<div id="failed" class="bg-red-300 dark:bg-red-800 py-3 text-white px-4 rounded-lg hidden"></div>
