...
@endif
<div id="success-2" class="bg-[#d1e7dd] dark:bg-green-800 text-[#0f5132] dark:text-green-100 border-2 border-[#badbcc] dark:border-green-600 px-4 py-3 rounded-lg fixed inset-x-6 md:inset-x-[296px] z-[999] hidden">
    <i class="fa-regular fa-circle-check mr-1"></i>
    <span></span>
</div>
<div id="failed" class="bg-[#f8d7da] dark:bg-red-800 text-[#842029] dark:text-red-100 border-2 border-[#f5c2c7] dark:border-red-600 px-4 py-3 rounded-lg fixed inset-x-6 md:inset-x-[296px] z-[999] hidden">
    <i class="fa-solid fa-circle-exclamation mr-1"></i>
    <span></span>
</div>
<div class="pb-4 flex flex-col items-center font-body">
    ...
    <div class="w-full flex-1">
        <div class="mx-auto max-w-xs">
            <form id="form" onsubmit="kirim('{{ route('pasien.verifikasi') }}', event)">
                @csrf
                ...
                <div class="content-center">
                    ...
                    <input class="w-full px-5 py-4 rounded-lg font-medium bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 placeholder-gray-400 dark:placeholder-gray-300 text-sm focus:outline-none focus:border-gray-400 focus:bg-white dark:focus:bg-gray-600 dark:text-gray-200"
                         type="number" placeholder="Masukkan Kode OTP"
                         autofocus name="kode_verifikasi" id="kode_verifikasi" >
                    <div id="error-message" class="text-[#B42223] dark:text-red-500 hidden"></div>
                </div>
                ...
                <button class="mt-5 tracking-wide font-semibold bg-[#374280] dark:bg-gray-500 text-gray-100 w-full py-4 rounded-lg hover:bg-[#222C67] dark:hover:bg-gray-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
