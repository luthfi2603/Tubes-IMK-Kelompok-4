...
<body class="font-body bg-[#E3EBF3]">
    <div class="container mx-auto px-4">
        ...
        <div class="w-full flex justify-between items-center pt-6">
            <img src="http://127.0.0.1:8000/assets/img/logo.png" alt="Logo Klinik RH61" class="w-36 h-auto sm:w-24 md:w-36 lg:w-36 xl:w-36 max-[640px]:w-24">
        </div>
        <!-- Main Content -->
        <div class="relative text-center pb-12">
            <h1 class="text-4xl sm:text-2xl md:text-4xl lg:text-4xl xl:text-4xl max-[640px]:text-xl font-bold text-[#0a0a0a] absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-24 max-[640px]:pt-10 sm:pt-10">
                Kelola Kesehatan Anda dan Masa Depan yang Bahagia
            </h1>
            <p class="mt-17 text-lg sm:text-base md:text-lg lg:text-xl xl:text-2xl max-[640px]:text-md text-gray-700 max-[640px]:pt-7 sm:pt-10">
        ...
        <div class="flex justify-center">
            <a href="{{ route('masuk.sebagai') }}" class="bg-[#222C67] hover:bg-[#525985] text-[#f5f5f5] text-xl font-bold pt-3 pb-3 px-6 border-[#222C67] hover:border-[#525985] rounded-lg shadow-lg max-[640px]:text-lg max-[640px]:px-3 py-2">Mulai Sekarang</a>
        </div>
