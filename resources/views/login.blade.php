                    ...
                    <div class="mx-auto max-w-xs">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="content-center">
                                <label for="nomor_telephone"
                                    class="ml-2 text-sm font-bold text-gray-700 tracking-wide">No Telepon</label>
                                <input
        ...
        <form method="POST" action="{{ route('login') }}" class="w-9/12 md:w-1/4 flex flex-col items-center">
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="number" name="nomor_handphone" id="nomor_handphone"
                    class="@error('nomor_handphone') bg-red-500 placeholder-white @enderror"
                    placeholder="Masukkan nomor handphone kamu" value="{{ old('nomor_handphone') }}" autofocus>
                @error('nomor_handphone')
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="password" name="password" id="password"
                    class="@error('password') bg-red-500 placeholder-white @enderror"
