...
<div class="flex justify-between items-center px-4 mb-3">
    <div class="font-body font-bold text-[#222C67]  dark:text-white">
        <h1 class="text-3xl font-bold text-[#222c67] dark:text-white">Dokter Kami</h1>
    </div>
</div>
<hr class="border-1 border-[#B1B0AF] dark:border-gray-700 mb-4 mx-4">
<div class="flex flex-col gap-4 p-5">
    <div class="bg-[#7f89c0] dark:bg-slate-600 text-white p-4 max-[640px]:p-3 rounded-lg flex items-center mb-4">
        <div class="flex-1">
    ...
    @else
        ...
        @foreach($dokters as $item)
            <div class="border-gray-300 dark:border-gray-700 rounded-2xl flex border-4 shadow-lg py-2 dark:bg-slate-800">
