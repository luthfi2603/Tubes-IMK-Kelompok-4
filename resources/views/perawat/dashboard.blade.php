    ...
    <div class="flex-1">
        ...
        <div class="relative w-full max-w-5xl mt-3">
            <div class="flex flex-col pb-5 px-5 rounded-xl bg-white shadow-lg w-full overflow-x-auto pt-4">
                <div class="relative my-1 flex items-center justify-end">
                    <div class="relative inline-block text-left">
                        <a href="{{ route('perawat.data.pasien') }}" id="options-button-2" type="button" class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <i class="fa-solid fa-angles-right"></i>
                        </a>
                    </div>
                </div>
                            ...
                            @else
                                ...
                                @foreach($pasiens as $item)
                                    <tr>
                                        ...
                                        <td class="py-2 pr-2 whitespace-nowrap text-md"><a href="{{ route('perawat.data.pasien') }}" class="text-blue-500">Detail</a></td>
                                    </tr>
                                    @php $i++; @endphp
                                @endforeach
                            @endif
        ...
        <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="relative inline-block text-left">
                        <a href="{{ route('perawat.index.dokter') }}" class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <i class="fa-solid fa-angles-right"></i>
                        </a>
                    </div>
                </div>
