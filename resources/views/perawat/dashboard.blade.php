        ...
        <div class="bg-[#222C67] p-6 rounded-lg shadow-lg">
            <div class="flex flex-col md:flex-row justify-between items-center max-[760px]:items-start">
                <div class="font-body text-white mb-4 md:mb-0">
                    ...
                    <h2 class="text-2xl font-semibold font-body text-white py-2">Siti Nurhaji</h2>
                    <p class="text-white py-1">Perawat</p>
                    <p class="pt-3 pb-1">Hari ini ada<span class="font-bold text-[#E8C51C]">12 Reservasi</span></p>
                </div>
