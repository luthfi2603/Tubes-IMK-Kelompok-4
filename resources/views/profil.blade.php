...
@if(session()->has('success'))
    <div id="success-php" class="bg-[#d1e7dd] dark:bg-green-800  text-[#0f5132] border-2 dark:text-green-200 border-[#badbcc] dark:border-green-700  px-4 py-3 rounded-lg fixed z-[999] inset-x-6 md:inset-x-[296px]">
        <i class="fa-regular fa-circle-check mr-1"></i>
        <span>{{ session('success') }}</span>
    </div>
@elseif(session()->has('failed'))
    <div id="failed-php" class="bg-[#f8d7da] text-[#842029] dark:bg-red-800 border-2 dark:text-red-200 dark:border-red-700 border-[#f5c2c7] px-4 py-3 rounded-lg fixed z-[999] inset-x-6 md:inset-x-[296px]">
...
<div class="container mx-auto p-4">
    ...
    <div id="success" class="bg-[#d1e7dd] text-[#0f5132] dark:bg-green-800 dark:text-green-200 dark:border-green-700 border-2 border-[#badbcc] px-4 py-3 rounded-lg fixed z-[999] inset-x-6 md:inset-x-[296px] hidden">
        <i class="fa-regular fa-circle-check mr-1"></i>
        <span></span>
    </div>
    <div id="failed-ubah-profil" class="bg-[#f8d7da] text-[#842029]  dark:bg-red-800 dark:text-red-200 dark:border-red-700 border-2 border-[#f5c2c7] px-4 py-3 rounded-lg fixed z-[999] inset-x-6 md:inset-x-[296px] hidden">
        <i class="fa-solid fa-circle-exclamation mr-1"></i>
        <span></span>
    </div>
