        ...
        <div class="mx-auto max-w-xs">
            <form method="POST" action="{{ route('password.edit') }}">
                ...
                <div class="content-center relative">
                    <label for="old_password" class="ml-2 text-sm font-bold text-gray-700 tracking-wide">Kata Sandi Lama</label>
                    <input
                ...
                <div class="content-center relative mt-4">
                    <label for="password" class="ml-2 text-sm font-bold text-gray-700 tracking-wide">Kata Sandi Baru</label>
                    <input
                        class="w-full px-5 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-400 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                ...
                <div class="content-center relative mt-4">
                    <label for="konfirmasi_password" class="ml-2 text-sm font-bold text-gray-700 tracking-wide">Konfirmasi Kata Sandi Baru</label>
                    <input
                        class="w-full px-5 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-400 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
