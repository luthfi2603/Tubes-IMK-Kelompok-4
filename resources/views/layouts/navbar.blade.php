...
<div class="fixed left-0 top-0 w-64 h-full bg-[#E3EBF3] dark:bg-slate-800 p-4 z-50 sidebar-menu transition-all -translate-x-full md:translate-x-0">
    ...
    <ul class="mt-4">
        ...
        <li class="mb-1 group">
            <a href="{{ route('pasien.rekam-medis') }}" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-[#222C67] hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 {{ request()->is('rekam-medis*') ? 'bg-[#222C67] text-white' : '' }}">
