    ...
    {{-- <div class="flex flex-col items-center">
        ...
        <form method="POST" action="{{ route('register') }}" class="w-9/12 md:w-1/4 flex flex-col items-center">
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="text" name="nama" id="nama" class="@error('nama') bg-red-500 placeholder-white @enderror"
                    placeholder="John Doe" value="{{ old('nama') }}" autofocus>
                @error('nama')
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="number" pattern="^\d+$" name="nomor_handphone" id="nomor_handphone"
                    class="@error('nomor_handphone') bg-red-500 placeholder-white @enderror" placeholder="08XXXXXXXX"
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="text" name="alamat" id="alamat"
                    class="@error('alamat') bg-red-500 placeholder-white @enderror" placeholder="Jalan Makmur"
                    value="{{ old('alamat') }}">
                @error('alamat')
                <div class="bg-red-300 text-white">
                    {{ $message }}
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                    class="@error('tanggal_lahir') bg-red-500 placeholder-white @enderror"
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="text" name="pekerjaan" id="pekerjaan"
                    class="@error('pekerjaan') bg-red-500 placeholder-white @enderror" placeholder="Pekerjaan"
                    value="{{ old('pekerjaan') }}">
                @error('pekerjaan')
                <div class="bg-red-300 text-white">
                    {{ $message }}
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="password" name="password" id="password"
                    class="@error('password') bg-red-500 placeholder-white @enderror" placeholder="Password">
                @error('password')
                <div class="bg-red-300 text-white">
                    {{ $message }}
                </div>
            ...
            <div class="flex flex-col mb-3 w-full">
                ...
                <input type="password" name="konfirmasi_password" id="konfirmasi_password"
                    class="@error('konfirmasi_password') bg-red-500 placeholder-white @enderror"
