...
<div class="container mx-auto p-4">
        ...
        <div class="flex flex-col lg:flex-row items-center">
            ...
            <div class="lg:w-1/2 p-4 text-[#E3EBF3]">
                ...
                <div class="flex space-x-4">
                    <button class="bg-[#E8C51C] hover:bg-[#d3da78] text-[#130D19] px-4 py-3 my-3 rounded-full shadow-md transition duration-300 font-semibold">Klik disini untuk Reservasi</button>
                </div>
            </div>
            <!-- Image Content -->
    ...
    <div id="peta-lokasi" class="bg-gradient-to-r from-teal-600 to-teal-500 rounded-lg shadow-lg p-6 mb-6">
    ...
    <!-- Emergency Contacts -->
    <div id="kontak-darurat" class="bg-gradient-to-r from-[#313b75] to-[#3e4a92] rounded-lg shadow-lg p-6 mb-6">
